                ...
                <div class="reply-comment">
                    @foreach ($binhluan->binhLuanCon as $phanhoi)
                        <div class="comment-item">
                            ...
                            <div class="comment-actions">
                                <button class="comment-action-btn reply-btn" wire:click="setReplyToReply({{ $binhluan->id }}, {{ $phanhoi->id }})">
                                    <i class="fas fa-reply"></i>
                                    Trả lời
                                </button>
                            </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <form wire:submit.prevent="guiBinhLuan">
                                                ...
                                                <div class="d-flex justify-content-end gap-2 mt-2">
                                                    <button type="button" class="btn-reply-cancel cancel-reply" wire:click="$set('id_reply', null)">
                                                        <i class="fas fa-times me-1"></i> Hủy
                                                    </button>
                                                    <button type="submit" class="btn-reply-submit">
                                                        <i class="fas fa-paper-plane me-1"></i> Trả lời
