                                    ...
                                    <div class="card h-100 shadow-sm"
                                        ...
                                        <div class="card-footer d-flex justify-content-between gap-2 align-items-center"
                                            ...
                                            <div class="">
                                                ...
                                                <a href="{{ route('admin.lop.nhap-diem_rl', $lop) }}"
                                                    class="btn btn-warning btn-sm"><i class="fa-solid fa-pencil "></i>Điểm
                                                    rèn
                                                    luyện
                                                </a>
                                                <a href="{{ route('admin.bienbanshcn.index', $lop) }}"
                                                    class="btn btn-success btn-sm text-white"><i
                                                        class="fa-solid fa-file-lines"></i> Biên bản SHCN</a>
                                            </div>
