            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('giangvien.phong.store') }}" method="POST" data-confirm>
                            @csrf
                            <div class="mb-3">
                                <label for="ten" class="form-label">Tên phòng học</label>
                                <input type="text"
                                    class="form-control @error('ten') is-invalid border-danger text-dark @enderror"
                                    value="{{ old('ten') }}" id="ten" name="ten">
                                @error('ten')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number"
                                    class="form-control @error('ten') is-invalid border-danger text-dark @enderror"
                                    value="{{ old('so_luong') }}" id="so_luong" name="so_luong">
                                @error('so_luong')
                                    <div class="text-danger">Thông báo lỗi: {{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    class="form-control @error('loai_phong') is-invalid border-danger text-dark @enderror"
                                    id="loai_phong" name="loai_phong">
