...
class ThoiKhoaBieuStoreRequestAPI extends FormRequest
{
    /**
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            $tietBatDau = $this->input('tiet_bat_dau');
            $tietKetThuc = $this->input('tiet_ket_thuc');

            if (is_numeric($tietBatDau) && is_numeric($tietKetThuc)) {
