...
class MonHocSeeder extends Seeder
{
    ...
    {
        MonHoc::insert([
            ['ten_mon' => "Tiếng Anh 1", "loai_mon_hoc" => 5],
            ['ten_mon' => "Giáo dục thể chất 1", "loai_mon_hoc" => 1],
            ['ten_mon' => "Pháp luật", "loai_mon_hoc" => 2],
            ['ten_mon' => "Toán cao cấp", "loai_mon_hoc" => 2],
            ['ten_mon' => "Toán rời rạc và Lý thuyết đồ thị", "loai_mon_hoc" => 2],
            ...
            ['ten_mon' => "Tiếng Anh 2", "loai_mon_hoc" => 5],
            ['ten_mon' => "Giáo dục thể chất 2", "loai_mon_hoc" => 1],
            ['ten_mon' => "Vật lý đại cương", "loai_mon_hoc" => 2],
            ...
            ['ten_mon' => "Giáo dục quốc phòng và an ninh", "loai_mon_hoc" => 5],
            ['ten_mon' => "Giáo dục chính trị 1", "loai_mon_hoc" => 2],
            ['ten_mon' => "Tiếng Anh 3", "loai_mon_hoc" => 5],
            ...
            ['ten_mon' => "Giáo dục chính trị 2", "loai_mon_hoc" => 2],
            ...
            ['ten_mon' => "Tiếng Anh 2/6", "loai_mon_hoc" => 5],
