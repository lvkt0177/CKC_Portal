...
Route::get('/lop/sinhvien/{type}/{id}', [LopController::class, 'list'])->name('lop.sinhvien');
Route::get('/lop/nhap-diem_rl/{type}/{id}', [LopController::class, 'nhapDiemRL'])->name('lop.nhap-diem_rl');
